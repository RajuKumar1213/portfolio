...
export function Hero() {
  return (
    <section className="md:w-6xl w-full mx-auto h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-20  overflow-hidden">
      <HeroBackground />

      {/* Text Content */}
      <div className="   flex flex-col items-start space-y-6 z-10 animate-fade-in-up pt-10 md:pt-0">
        ...
        <div className="flex items-center gap-4 pt-8">
          ...
          <Link href="mailto:example@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
      ...
      <div className="flex-1 flex items-center justify-center relative mt-12 md:mt-0 z-10 animate-fade-in-left">
        <div className="relative w-64 h-64 md:w-96 md:h-96">
            ...
            <div className="relative w-full h-full rounded-full border-2 border-primary/20 bg-background/50 backdrop-blur-sm flex items-center justify-center overflow-hidden shadow-2xl">
